...
import { Button, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, FormControl, FormHelperText, FormLabel, NumberDecrementStepper, NumberIncrementStepper, NumberInput, NumberInputField, NumberInputStepper, Select, Text, useBreakpointValue } from '@chakra-ui/react';
import { FiGrid } from 'react-icons/fi';

const AddCategoryDrawer = ({ isOpen, onClose, fullCategoriesList, currentCategoriesList, setCurrentCategoriesList, currentTotalPoint, setCurrentTotalPoint, newCampaignDetail, setNewCampaignDetail }) => {
